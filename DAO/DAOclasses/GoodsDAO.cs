...

    {
        ...
        public bool AddGoods(Goods goods)
        {
            ...
            try
            {
                ...
                @"INSERT INTO [Goods] (Category, Price,Name,Quantity,ProvidedBy) " +
            "VALUES (@Category, @Price, @Name, @Quantity, @ProvidedBy)", Connection);
                cmd.Parameters.Add(new SqlParameter("@Category",
               goods.Category));
                cmd.Parameters.Add(new SqlParameter("@Price",
               goods.Price));
                cmd.Parameters.Add(new SqlParameter("@Name",
               goods.Name));
                cmd.Parameters.Add(new SqlParameter("@Quantity",
              goods.Quantity));
                cmd.Parameters.Add(new SqlParameter("@ProvidedBy",
               goods.ProvidedBy));
                cmd.ExecuteNonQuery();
            }
            catch (Exception)
